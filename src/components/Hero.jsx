...
const Hero = () => {
  return (
    ...
    '>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalled Luxury and comfort await at the world's most exclusive rooms and resorts... Start Your Jounary Today.</p>
