    ...
    <div className="bg-white">
      ...
      <header className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-semibold text-center">Safety Information</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <div>
            <h2 className="text-2xl font-semibold mb-6 pb-2 border-b border-gray-200">Property Safety</h2>
            <ul className="space-y-6">
              <li>
                <h3 className="text-xl font-medium mb-2">Fire Safety</h3>
              ...
              <li>
                <h3 className="text-xl font-medium mb-2">Pool Safety</h3>
                <p className="text-gray-700">
              ...
              <li>
                <h3 className="text-xl font-medium mb-2">Security Systems</h3>
                <p className="text-gray-700">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6 pb-2 border-b border-gray-200">Guest Safety</h2>
            <ul className="space-y-6">
              <li>
                <h3 className="text-xl font-medium mb-2">Emergency Assistance</h3>
                <p className="text-gray-700">
              ...
              <li>
                <h3 className="text-xl font-medium mb-2">Health Concerns</h3>
                <p className="text-gray-700">
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <h2 className="text-2xl font-semibold mb-6 text-center">Safety Tips for Your Stay</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-medium mb-3">Before You Arrive</h3>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-medium mb-3">During Your Stay</h3>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-medium mb-3">Local Awareness</h3>
              <ul className="space-y-2 text-gray-700">
